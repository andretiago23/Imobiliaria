 ...
 *
 * Como o protótipo não tem parceria real com nenhuma imobiliária, o cadastro
 * é feito dentro do próprio sistema, sem aprovação externa: quem cria a
...
public class ImobiliariaServico {
	...
	public List<Imobiliaria> listarAtivas() throws DAOException {
		return imobiliariaDAO.listarAtivas();
	}
