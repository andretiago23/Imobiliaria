...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/wizard.css?v=24">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/validacao.js?v=24"></script>
<script src="${pageContext.request.contextPath}/js/formulario.js?v=24"></script>
<script src="${pageContext.request.contextPath}/js/anuncio-wizard.js?v=24"></script>
</body>
</html>
