...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/perfil.css?v=38">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/validacao.js?v=38"></script>
<script src="${pageContext.request.contextPath}/js/formulario.js?v=38"></script>
<script>
