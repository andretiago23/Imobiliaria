...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/perfil.css?v=23">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/validacao.js?v=23"></script>
<script src="${pageContext.request.contextPath}/js/formulario.js?v=23"></script>
</body>
</html>
