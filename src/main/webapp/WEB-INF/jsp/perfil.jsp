...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/perfil.css?v=43">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/validacao.js?v=43"></script>
<script src="${pageContext.request.contextPath}/js/formulario.js?v=43"></script>
<script>
