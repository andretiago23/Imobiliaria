...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/catalogo.css?v=44">
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/perfil.css?v=44">
</head>
<body>
...
<script src="${pageContext.request.contextPath}/js/validacao.js?v=44"></script>
<script src="${pageContext.request.contextPath}/js/formulario.js?v=44"></script>
<script>
