...
<main>
  <!-- ===================== HERO ===================== -->
  <section class="section hero hero--anunciante">
    <div class="hero--anunciante__grid">
      <div class="hero--anunciante__copy">
        <h1 class="display" style="font-size:clamp(40px,5.5vw,64px);">Seu imóvel visto por quem <span class="hl">está procurando</span>, hoje.</h1>
        <div class="cta__actions" style="margin-top:40px;">
          ...
          <a class="btn btn--secondary btn--lg btn--interactive" href="${pageContext.request.contextPath}/planos">
      ...
      <div class="hero--anunciante__foto">
        <img src="${pageContext.request.contextPath}/imagens/hero-anunciante.jpg" alt="Casal comemorando a mudança para o novo imóvel">
      </div>
    </div>
  </section>
